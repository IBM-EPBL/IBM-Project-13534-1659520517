...
COS_API_KEY_ID="sX3_DLjiCJdYtG8FnWAWm_uWBvzG8g3GseQ3gjMjycnx",
COS_INSTANCE_CRN="crn:v1:bluemix:public:iam-identity::a/c0c98001984746dcb59b367f146f93b5::serviceid:ServiceId-27129::"
...
@app.route('/')
def index():
    files = get_bucket_contents('nalayathiran')
